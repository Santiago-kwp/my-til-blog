...
title1, title2 = '16 bit unchanged', '32 bit unchanged'
...
if color2unchanged1 is None or color2unchanged2 is None:    # 영상파일 예외처리
...
print(title2, "화소값(3원소)", color2unchanged2[10, 10])         # 한 화소값 표시
print()
