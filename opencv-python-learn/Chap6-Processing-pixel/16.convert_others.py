...
if BGR_img is None: raise FileNotFoundError

Gray_img = cv2.cvtColor(BGR_img, cv2.COLOR_BGR2GRAY)    # 명암도 영상변환
...
LAB_img = cv2.cvtColor(BGR_img, cv2.COLOR_BGR2LAB)      # La*b* 컬러공간변환
